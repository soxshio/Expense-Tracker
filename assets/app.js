...
document.addEventListener('DOMContentLoaded', function(){
    ...
    // Inline edit for transactions (delegated handler)
    function buildActionsHtml(id){
        return `<button class="btn editBtn" data-id="${id}" style="background:#f97316;padding:6px 8px;font-size:13px">Edit</button> <button class="btn deleteBtn" data-id="${id}" aria-label="Delete transaction" style="background:#ef4444;padding:6px 8px;font-size:13px;margin-left:6px">Delete</button>`;
    }
    ...
    document.addEventListener('click', function(e){
        ...
        cancelBtn.addEventListener('click', function(){
            ...
            cells.actions.innerHTML = buildActionsHtml(id);
    ...
    document.addEventListener('click', function(e){
        ...
        const amount = amountCell ? (parseFloat(amountCell.textContent.replace(/[^0-9.\-]/g,'')) || 0) : 0;
        ...
        fetch('soft_delete_transaction.php', {
            ...
            if (data.ok) {
                ...
                const parseDisplayed = function(el) {
                    if (!el) return 0;
                ...
                // increment trash count badge if present
